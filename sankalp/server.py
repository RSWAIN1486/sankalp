...
TOOLS = [
    ...
    {"name": "file_list", "description": "List files and folders inside allowed local roots."},
    {"name": "file_find", "description": "Recursively find files and folders by name inside allowed local roots."},
...
COMMANDS = [
    ...
    {"command": "/ls [path]", "description": "List files and folders under allowed local roots."},
    {"command": "/find <name>", "description": "Recursively find files or folders under allowed local roots."},
